...
class TestCalculateAIMetrics:
    ...
    async def test_excellent_deal_15_percent_off(self, negotiation_service):
    ...
    async def test_very_good_deal_10_to_15_percent_off(self, negotiation_service):
    ...
    async def test_good_deal_5_to_10_percent_off(self, negotiation_service):
    ...
    async def test_fair_deal_2_to_5_percent_off(self, negotiation_service):
    ...
    async def test_marginal_deal_less_than_2_percent_off(self, negotiation_service):
    ...
    async def test_negative_discount_price_increase(self, negotiation_service):
    ...
    async def test_dealer_very_flexible(self, negotiation_service):
    ...
    async def test_dealer_moderate_flexibility(self, negotiation_service):
    ...
    async def test_many_rounds_little_movement(self, negotiation_service):
    ...
    async def test_early_stage_low_concession(self, negotiation_service):
    ...
    async def test_early_stage_normal_concession(self, negotiation_service):
    ...
    async def test_zero_round_count_edge_case(self, negotiation_service):
    ...
    async def test_zero_asking_price_edge_case(self, negotiation_service):
    ...
    async def test_consider_action_with_decent_discount(self, negotiation_service):
    ...
    async def test_negotiation_velocity_multiple_rounds(self, negotiation_service):
