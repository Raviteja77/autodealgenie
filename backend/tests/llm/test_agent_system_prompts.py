...
class TestAgentSystemPrompts:
    ...
    def test_loan_agent_prompt_structure(self):
        ...
        assert "when lender recommendation data is provided" in loan_prompt.lower() or \
               "when lender" in loan_prompt.lower()
    ...
    def test_negotiation_agent_prompt_structure(self):
        ...
        assert "leverage" in negotiation_prompt.lower()
        assert "dealer financing" in negotiation_prompt.lower() or \
               "dealer" in negotiation_prompt.lower()
    ...
    def test_evaluator_agent_prompt_structure(self):
        ...
        assert "vehicle price" in evaluator_prompt.lower() or \
               "financing cost" in evaluator_prompt.lower()
