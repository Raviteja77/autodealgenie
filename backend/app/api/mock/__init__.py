...
mock_router.include_router(
    mock_services_router, prefix="/marketcheck", tags=["mock-marketcheck"]
)
mock_router.include_router(mock_services_router, prefix="/llm", tags=["mock-llm"])
mock_router.include_router(
    mock_services_router, prefix="/negotiation", tags=["mock-negotiation"]
)
mock_router.include_router(
    mock_services_router, prefix="/evaluation", tags=["mock-evaluation"]
)
